...
interface CartShoppingProps extends SVGAttributes<SVGSVGElement> {}

export const CartShopping: React.FC<CartShoppingProps> = (props) => {
  return (
    <>
      <svg
        width="24"
