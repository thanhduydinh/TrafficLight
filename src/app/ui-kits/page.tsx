...
import { Search, CartPlus } from "@/assets/icons/Index";
...
export default function UIKits() {
  ...
  const handleClickFavorite = (isfavorite: boolean | undefined, id: number) => {
    const foundItem = listItems.find((item) => item.id === id);
    if (foundItem) {
      foundItem.isFavourite =
        isfavorite !== undefined ? isfavorite : !foundItem.isFavourite;
      //Call Api
    }
  };
  ...
  const listItems = [
    ...
    },
    {
      id: 5,
      imgUrl:
        "https://s3-alpha-sig.figma.com/img/1fad/5657/f4dcd35c8e416c81aa0d8c4006d90ad4?Expires=1716768000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=jPyC9TBxT3ByRbMiL2oN2ZHNWu6PB852msqH2VbFAEDkJbVVZmAN8JcDd6IU-KlueZTw3KAs1Er~FmKCZHAl6YUgSUbScmfE08UrCzJrFRFe9~ymuh~AduzKdPKyraqPgpbe4eOZtaNBkC8Uv5b62Hze5Q9mn2TD5iweWLK-3BWQ2yY0f8ZMe9AfrAxu4AnFs0hZH~69tCu4Jyhi4snxIGTVzes~CRGQYE-zqhghTsKtKUqliYHpVNYXqT7TdpnWs32iGIAYu209uCPlbn5RuHORqyL4mcg2DeZmg~fql8cT0dFM7UEViOBR1R8jJW6gwkO7lzNC~KMktZ~1lXY4~Q__",
      title:
        "Đèn Ngủ Giá Rẻ Phong Cách Tân Cổ Điển [ SIÊU GIẢM GIÁ ] Đèn Có...",
      currentPrice: "1.045.000đ",
      previousPrice: "2.000.000đ",
